<template>
    <div>
          <div> 
            the number of comments about this product:1010
            <b-row class="my-1">
              <b-col sm="9">
                  <span v-if="registerBtnClicked">
                      <commentCreate :id="Number(id)"/>
                  </span>
                  <span v-else>
                      <commentDiagram/>
                  </span>
...
import commentDiagram from './commentDigram'
