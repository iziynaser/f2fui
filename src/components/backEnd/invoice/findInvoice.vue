    ...
    <div>
          ...
          <f2fInvoiceType id="invoiceType" 
            ...
            <b-form-group label="status ">
                  <b-form-checkbox-group id="checkbox-group-0" v-model="selectedInvoiceActionTypes" name="falvor-1" >
                        <b-form-checkbox v-for="actionType in invoiceActionTypes" :key="actionType.id" :value="actionType.name">
                              {{actionType.name}}
                        </b-form-checkbox>
